...
class App extends Component {
  ...
  async deposit(amount) {
    this.state.dbank.methods.deposit().send({value: amount.toString(), from: this.state.account})
  }

  async withdraw(e) {
    e.preventDefault()
    if (this.state.dbank !== 'undefined') {
      await this.sate.dbank.methods.withdraw().send({from: this.state.account});
    }
  }
